...
assert summary == {
    ...
    "remaining_signature_clusters": 1, "governed_label_overrides": 15,
...
assert all(by_id[concept_id]["impact"] == "identity-text-corrected" for concept_id in {"AOM_001265", "AOM_001462"})
