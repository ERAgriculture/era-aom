...
assert len(rows) == 261 and len({row["concept_id"] for row in rows}) == 261
...
print("Definition-gap classification validation passed: 261 routed; 18 integrity holds remain")
