...
assert len(rows) == 252 and len({row["concept_id"] for row in rows}) == 252
...
print("Definition-gap classification validation passed: 252 routed; 12 integrity holds remain")
