...
assert {row["status"] for row in preferred_collisions} <= {
    "approved-retain-distinct", "approved-identity-hold"
}
...
assert signals[("active governed vocabulary", "missing definitions")] == 18
