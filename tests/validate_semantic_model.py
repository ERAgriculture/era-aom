...
assert len(material_facets) == 1636
...
assert len({row["facet_id"] for row in facets}) == 10
...
print("Semantic model validation passed: 50 dispositions; 13 structural, 418 value bindings, 12 facets, 1636 material assertions")
