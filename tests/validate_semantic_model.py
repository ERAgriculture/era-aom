...
assert len(material_facets) == 1783
...
print("Semantic model validation passed: 50 dispositions; 13 structural, 418 value bindings, 12 facets, 1783 material assertions")
