...
assert len(material_facets) == 1728
...
print("Semantic model validation passed: 50 dispositions; 13 structural, 418 value bindings, 12 facets, 1728 material assertions")
