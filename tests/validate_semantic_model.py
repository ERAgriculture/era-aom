...
assert len(material_facets) == 1765
...
print("Semantic model validation passed: 50 dispositions; 13 structural, 418 value bindings, 12 facets, 1765 material assertions")
