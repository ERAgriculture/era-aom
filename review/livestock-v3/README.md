...
ADR 0014 closes all remaining cases: 11 atomic mappings, 26 assertions across
11 composites, and nine explicit null-target holds. `Hash` is reclassified from
unresolved to composite after private contextual audit plus published evidence.
