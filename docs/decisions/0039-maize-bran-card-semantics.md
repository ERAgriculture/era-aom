...
“Entry terms” remains Skosmos terminology for `skos:altLabel`: accepted
alternative names used for search and discovery, not extra ingredients or
subclasses. For this card, `Corn Bran` is an entry term for `Maize Bran`.
