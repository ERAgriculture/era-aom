# AOM livestock staging distributions

Generated, noncanonical review outputs:
...
`urn:era-aom:*` identifiers are provisional staging URIs. Formal publication
waits for approved persistent HTTPS namespace.
